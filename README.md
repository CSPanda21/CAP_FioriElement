...
**Next Steps:**
- 'Radial Micro Chart' added but populate it with the right value. You can add criticality also to show the semantic colouring for the chat.    Check the below link.
